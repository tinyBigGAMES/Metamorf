...
//
// NOTE: This dialect uses // for comments instead of traditional ;
// because ; is reserved as delimiter.semicolon for C++ passthrough
// interop (the # handler needs it as a stop signal).
// ---------------------------------------------------------------------------
